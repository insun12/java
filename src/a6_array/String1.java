...
public class String1 {
    public static void main(String[] args) {
        ...
        System.out.println(str1); // 10 이지만 숫자가 아니라 문자
        double b = 5.5;
        String str2 = Double.toString(b); // 5.5 문자
        System.out.println(str2);
        boolean c = true;
        String str3 = Boolean.toString(c); // true 문자
        // 기본자료형의 래퍼(wrapper)클래스
        // Byte, Short, Integer, Long, Double, Character, Boolean
        // 모든 기본자료형과 1대1로 대응됨
        // 불변성을 가짐 (수정안됨)
        // 생성자를 사용하지 않고 대신 valueOf() 메서드를 사용하여 객체 생성
        // ★ 래퍼(wrapper)클래스를 왜 사용하나? ★
        ...
        // 컬렉션(리스트, 세트, 맵, 트리...) 에 사용할 목적으로 주로 사용ㅇ
    }
}
